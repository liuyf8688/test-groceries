...
public class _LogFactoryImpl extends LogFactory {
    ...
    public Log getInstance(String name) throws LogConfigurationException {
        ...
        System.out.println("=====instance name of Log: " + instance);
        System.out.println("=====instance of Log: " + instance);
        if (instance == null) {
    ...
    private void initDiagnostics() {
        ...
        System.out.println("=====diagnosticPrefix: " + diagnosticPrefix);
    }
    ...
    protected Log newInstance(String name) throws LogConfigurationException {
        ...
        try {
            ...
            System.out.println("=====new instance of Log: " + instance);
            return instance;
    ...
    private Log discoverLogImplementation(String logCategory)
        ...
        System.out.println("=====specifiedLogClassName: " + specifiedLogClassName);
        ...
        for(int i=0; i<classesToDiscover.length && result == null; ++i) {
        	System.out.println("=====classesTodiscover[" + i + "]: " + classesToDiscover[i]);
    ...
    private Log createLogFromClass(String logAdapterClassName,
    	...
    	System.out.println("=====Attempting to instantiate '" + logAdapterClassName + "'");
        if (isDiagnosticsEnabled()) {
        ...
        for(;;) {
        	...
        	System.out.println("Trying to load '" + logAdapterClassName + "' from classloader " + objectId(currentCL));
    ...
    private ClassLoader getBaseClassLoader() throws LogConfigurationException {
        ClassLoader thisClassLoader = getClassLoader(_LogFactoryImpl.class);
