...
public abstract class _LogFactory {
     ...
     */
    protected static volatile _LogFactory nullClassLoaderFactory = null;
     ...
     */
    public static _LogFactory getFactory() throws LogConfigurationException {
        ...
        _LogFactory factory = getCachedFactory(contextClassLoader);
        if (factory != null) {
            return factory;
        }
    ...
    /**
     * Release any internal references to previously created {@link _LogFactory}
    ...
    public static void release(ClassLoader classLoader) {
        ...
        final Hashtable factories = _LogFactory.factories;
        synchronized (factories) {
            if (classLoader == null) {
                ...
                final _LogFactory factory = (_LogFactory) factories.get(classLoader);
                if (factory != null) {
                    factory.release();
    ...
    public static void releaseAll() {
        ...
        synchronized (factories) {
            ...
            while (elements.hasMoreElements()) {
                _LogFactory element = (_LogFactory) elements.nextElement();
                element.release();
            }
            factories.clear();
     ...
     */
    private static _LogFactory getCachedFactory(ClassLoader contextClassLoader) {
        if (contextClassLoader == null) {
            ...
            return (_LogFactory) factories.get(contextClassLoader);
        }
    }
     ...
     */
    private static void cacheFactory(ClassLoader classLoader, _LogFactory factory) {
     ...
     * @since 1.1
     */
    protected static _LogFactory newFactory(final String factoryClass,
        ...
        try {
            if (classLoader != null) {
                try {
                    ...
                    if (_LogFactory.class.isAssignableFrom(logFactoryClass)) {
                        if (isDiagnosticsEnabled()) {
                        ...
                        if (isDiagnosticsEnabled()) {
                            logDiagnostic("Factory class " + logFactoryClass.getName() +
                                          ...
                                          " does not extend '" + _LogFactory.class.getName() +
                                          "' as loaded by this classloader.");
                            logHierarchy("[BAD CL TREE] ", classLoader);
                        }
                    }

                    return (_LogFactory) logFactoryClass.newInstance();
                    ...
                    if (classLoader == thisClassLoader) {
                        ...
                        msg.append(_LogFactory.class.getName());
                        msg.append("'. ");
            ...
            if (logFactoryClass != null && !_LogFactory.class.isAssignableFrom(logFactoryClass)) {
    ...
    static {
        ...
        thisClassLoader = getClassLoader(_LogFactory.class);
        ...
        logClassLoaderEnvironment(_LogFactory.class);
